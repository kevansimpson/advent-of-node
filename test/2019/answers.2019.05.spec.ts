...
describe('2019 solutions - Day 05', () => {
  ...
  it('enhancedProgram => 1', async () => assert.strictEqual(enhancedProgram([...input])[0], d05.part1))
  it('enhancedProgram => 5', async () => assert.strictEqual(enhancedProgram([...input], 5)[0], d05.part2))
})
