...
import { solve as day25 } from '../src/2024/day25'
...
describe('2024 answers', () => {
  ...
  it('Day25: code chronicle', async () => {
    const result = day25(readLines(path.join(__dirname, './resources/2024/input25.txt')))
    assert.strictEqual(result, 3021)
  })
})
