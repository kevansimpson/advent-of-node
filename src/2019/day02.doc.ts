 ...
 */
export const part1: number = 4570637
 ...
 * opcode, if any, are called the instruction's parameters. For example, in the instruction 1,2,3,4,
 ...
 */
export const part2: number = 5485
