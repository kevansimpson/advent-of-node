...
/**
 * <h2>Part 1</h2>
 * While you were learning about instruction pointers, the Elves made considerable progress. When you look up,
 * you discover that the North Pole base construction project has completely surrounded you.
 *
 ...
 * </pre>
 *
 * You get the attention of a passing construction Elf and ask for a map. "I don't have time to draw out a map
 * of this place - it's huge. Instead, I can give you directions to every room in the facility!" He writes down
 * some directions on a piece of parchment and runs off. In the example above, the instructions might have been
 ...
 * parentheses. So, ^N(E|W)N$ contains a branch: after going north, you must choose to go either east or west befor
 ...
 * (NEWS|), (WNSE|), and (SWEN|). Regardless of which option is taken, the route continues from the position it is left at
 * after taking those steps. So, for example, this regex matches all of the following routes (and more that aren't listed here):
 * <pre>
 *  - ENNWSWWSSSEENEENNN
 ...
 *
 * To get a sense for the size of this facility, you'd like to determine which room is furthest from you: specifically, you would
 * like to find the room for which the shortest path to that room would require passing through the most doors.
 * <pre>
 ...
 * </pre>
 *
 * What is the largest number of doors you would be required to pass through to reach a room? That is, find the room for which
 * the shortest path from your starting location to that room would require passing through the most doors; what is the fewest
 * doors you can pass through to reach it?
 */
export const part1: number = 4372 // too high but 4340 is too low and 4462 is too high
 ...
 */
export const part2: number = 190820
