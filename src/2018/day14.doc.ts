 ...
 * My puzzle input.
 */
export const input: number = 509671
 ...
 * current recipes' scores of 3 and 7, their sum is 10, and so two new recipes would
 * be created: the first with score 1 and the second with score 0. If the current
 * recipes' scores were 2 and 3, the sum, 5, would only create one recipe (with a
 ...
 * 1 plus the score of their current recipe. So, after the first round, the first Elf
 * moves forward 1 + 3 = 4 times, while the second Elf moves forward 1 + 7 = 8 times.
 * If they run out of recipes, they loop back around to the beginning. After the first
 * round, both Elves happen to loop around until they land on the same recipe that they
 * had in the beginning; in general, they will move to different recipes.
 *
 ...
 * scores of the ten recipes after that. For example:
 * <ul>
 *    <li>If the Elves think their skill will improve after making 9 recipes, the scores
 *        of the ten recipes after the first nine on the scoreboard would be 5158916779
 *        (highlighted in the last line of the diagram).</li>
 *    <li>After 5 recipes, the scores of the next ten would be 0124515891.</li>
 *    <li>After 18 recipes, the scores of the next ten would be 9251071085.</li>
 *    <li>After 2018 recipes, the scores of the next ten would be 5941429882.</li>
 *
 * What are the scores of the ten recipes immediately after the number of recipes in your puzzle input?
 */
export const part1: string = '2810862211'
 ...
 * <ul>
 *    <li>51589 first appears after 9 recipes.</li>
 *    <li>01245 first appears after 5 recipes.</li>
 *    <li>92510 first appears after 18 recipes.</li>
 *    <li>59414 first appears after 2018 recipes.</li>
 * </ul>
 *
 * How many recipes appear on the scoreboard to the left of the score sequence in your puzzle input?
 */
export const part2: number = 20227889
