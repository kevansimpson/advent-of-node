 ...
 * as you can see to your left and right. A few of them contain plants - someone is trying to grow
 ...
 * right and whether they do (#) or do not (.) currently contain a plant, the initial state.
 * (No other pots currently contain plants.) For example, an initial state of #..##.... indicates
 ...
 * on either side of it) had a plant in the last generation. These are written as LLCRR => N,
 * where L are pots to the left, C is the current pot being considered, R are the pots to the right,
 ...
 *                              previous generation, there were plants in that pot, the one
 *                              immediately to the left, and the one two pots to the right,
 ...
 * the current configuration of plants is sustainable by determining what will happen after 20 generations.
 *
 ...
 */
export const part1: number = 2349
 ...
 */
export const part2: number = 2100000001168
