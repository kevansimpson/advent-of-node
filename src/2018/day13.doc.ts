 ...
 * time, and then repeats those directions starting again with left the fourth time,
 ...
 * to right), then carts on the third row, and so on. Once each cart has moved one
 * step, the process repeats; each of these loops is called a tick.
 *
 ...
 */
export const part1: Point = [113, 136]
 ...
 */
export const part2: Point = [114, 136]
