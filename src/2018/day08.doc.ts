 ...
 * The numbers define a data structure which, when processed, produces some kind of tree that
 ...
 */
export const part1: number = 38722
 ...
 */
export const part2: number = 13935
