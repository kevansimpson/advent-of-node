 ...
 * of any letter. You can multiply those two counts together to get a rudimentary checksum and compare it
 ...
 */
export const part1: number = 3952
 ...
 */
export const part2: string = 'vtnikorkulbfejvyznqgdxpaw'
