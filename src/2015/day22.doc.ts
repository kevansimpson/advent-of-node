 ...
 * @module 2015_day22
 */
import { Boss } from './day22'

/**
 * Boss
 */
export const boss: Boss = { damage: 10, hitPoints: 71 }
 ...
 * as well. As before, if armor (from a spell, in this case) would reduce damage below 1, it becomes
 ...
 * any spell, you lose. Spells cost mana; you start with 500 mana, but have no maximum limit. You
 * must have enough mana to cast a spell, and its cost is immediately deducted when you cast it.
 ...
 */
export const part1 = 1824

/**
 * <h2>Part 2</h2>
 * On the next run through the game, you increase the difficulty to hard.
 *
 * At the start of each player turn (before any other effects apply), you lose 1 hit point. If this brings
 * you to or below 0 hit points, you lose.
 *
 * With the same starting stats for you and the boss, what is the least amount of mana you can spend and
 * still win the fight?
 */
export const part2 = 1937
