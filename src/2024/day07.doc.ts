...
/**
 * <h2>Part 1</h2>
 * The Historians take you to a familiar rope bridge over a river in the middle of a jungle. The Chief isn't on
 * this side of the bridge, though; maybe he's on the other side?
 *
 ...
 * <ul>
 *  <li>190: 10 19 has only one position that accepts an operator: between 10 and 19. Choosing + would give 29,
 *      but choosing * would give the test value (10 * 19 = 190).</li>
 *  <li>3267: 81 40 27 has two positions for operators. Of the four possible configurations of the operators,
 *      two cause the right side to match the test value: 81 + 40 * 27 and 81 * 40 + 27 both equal 3267 (when
 *      evaluated left-to-right)!</li>
 ...
 * equations that could possibly be true. In the above example, the sum of the test values for the three equations
 * listed above is 3749.
 *
 * Determine which equations could possibly be true. What is their total calibration result?
 */
export const part1: number = 42283209483350
 ...
 */
export const part2: number = 1026766857276279
