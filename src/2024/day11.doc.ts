 ...
 *
 * At first glance, they seem like normal stones: they're arranged in a perfectly straight line, and each stone
 * has a number engraved on it.
 *
 * The strange part is that every time you blink, the stones change.
 *
 * Sometimes, the number engraved on a stone changes. Other times, a stone might split in two, causing all the
 * other stones to shift over a bit to make room in their perfectly straight line.
 *
 ...
 *  <li>If the stone is engraved with a number that has an even number of digits, it is replaced by two stones.
 ...
 *      stones 10 and 0.)</li>
 *  <li>If none of the other rules apply, the stone is replaced by a new stone; the old stone's number multiplied
 *      by 2024 is engraved on the new stone.</li>
 * </ul>
 * No matter how the stones change, their order is preserved, and they stay on their perfectly straight line.
 *
 * How will the stones evolve if you keep blinking at them? You take a note of the number engraved on each stone
 * in the line (your puzzle input).
 *
 * If you have an arrangement of five stones engraved with the numbers 0 1 10 99 999 and you blink once, the
 * stones transform as follows:
 * <ul>
 ...
 */
export const part1: number = 203609
 ...
 */
export const part2: number = 240954878211138
