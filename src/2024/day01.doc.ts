 ...
 * <ul>
 * <li>The smallest number in the left list is 1, and the smallest number in the right list is 3.
 *     The distance between them is 2.</li>
 * <li>The second-smallest number in the left list is 2, and the second-smallest number in the
 *     right list is another 3. The distance between them is 1.</li>
 ...
 * <li>Finally, the largest number in the left list is 4, while the largest number in the right
 *     list is 9; these are a distance 5 apart.</li>
 * </ul>
 *
 ...
 * your lists?
 */
export const part1: number = 2057374
 ...
 * location IDs appear in both lists! Maybe the other numbers aren't location IDs at all but
 ...
 * <ul>
 * <li>The first number in the left list is 3. It appears in the right list three times, so the
 *     similarity score increases by 3 * 3 = 9.</li>
 * <li>The second number in the left list is 4. It appears in the right list once, so the
 *     similarity score increases by 4 * 1 = 4.</li>
 * <li>The third number in the left list is 2. It does not appear in the right list, so the
 *     similarity score does not increase (2 * 0 = 0).</li>
 * <li>The fourth number, 1, also does not appear in the right list.</li>
 * <li>The fifth number, 3, appears in the right list three times; the similarity score
 *     increases by 9.</li>
 * <li>The last number, 3, appears in the right list three times; the similarity score again
 *     increases by 9.</li>
 * </ul>
 *
 ...
 */
export const part2: number = 23177084
