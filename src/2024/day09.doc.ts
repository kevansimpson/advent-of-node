...
/**
 * <h2>Part 1</h2>
 * Another push of the button leaves you in the familiar hallways of some friendly amphipods! Good thing you
 * each somehow got your own personal mini submarine. The Historians jet away in search of the Chief, mostly
 ...
 * four blocks of free space, and then a five-block file. A disk map like 90909 would represent three
 ...
 *
 * <pre>0..111....22222</pre>
 * The first example above, <pre>2333133121414131402</pre>, represents these individual blocks:
 *
 * <pre>00...111...2...333.44.5555.6666.777.888899</pre>
 ...
 * add up the result of multiplying each of these blocks' position with the file ID number it contains. The
 * leftmost block is in position 0. If a block contains free space, skip it instead.
 *
 * Continuing the first example, the first few blocks' position multiplied by its file ID number are
 * <pre>0 * 0 = 0, 1 * 0 = 0, 2 * 9 = 18, 3 * 9 = 27, 4 * 8 = 32</pre>, and so on. In this example, the checksum
 * is the sum of these, 1928.
 *
 * Compact the amphipod's hard drive using the process he requested. What is the resulting filesystem checksum?
 */
export const part1: number = 6334655979668
 ...
 * highest file ID number. If there is no span of free space to the left of a file that is large enough to fit
 * the file, the file does not move.
 *
 ...
 * filesystem checksum?
 */
export const part2: number = 6349492251099
