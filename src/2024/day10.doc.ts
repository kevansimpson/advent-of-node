...
/**
 * <h2>Part 1</h2>
 * You all arrive at a Lava Production Facility on a floating island in the sky. As the others begin to search
 * the massive industrial complex, you feel a small nose boop your leg and look down to discover a reindeer
 * wearing a hard hat.
 *
 * The reindeer is holding a book titled "Lava Island Hiking Guide". However, when you open the book, you
 * discover that most of it seems to have been scorched by lava! As you're about to ask how you can help, the
 * reindeer brings you a blank topographic map of the surrounding area (your puzzle input) and looks up at you
 * excitedly.
 *
 ...
 * 9876
 * </pre>
 * Based on un-scorched scraps of the book, you determine that a good hiking trail is as long as possible and
 * has an even, gradual, uphill slope. For all practical purposes, this means that a hiking trail is any path
 * that starts at height 0, ends at height 9, and always increases by a height of exactly 1 at each step. Hiking
 ...
 * of 5, 6, 5, 3, 1, 3, 5, 3, and 5. Adding these scores together, the sum of the scores of all trailheads is 36.
 *
 ...
 *
 * The paper describes a second way to measure a trailhead called its rating. A trailhead's rating is the number
 * of distinct hiking trails which begin at that trailhead. For example:
 * <pre>
 * .....0.
 * ..4321.
 * ..5..2.
 ...
 * ..9....
 * </pre>
 * The above map has a single trailhead; its rating is 3 because there are exactly three distinct hiking trails
 ...
 * 10456732
 * </pre>
 * Considering its trailheads in reading order, they have ratings of 20, 24, 10, 4, 1, 4, 5, 8, and 5. The sum of
 * all trailhead ratings in this larger example topographic map is 81.
 *
 ...
 */
export const part2: number = 1514
